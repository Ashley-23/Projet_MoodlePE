                    ...
                    <div class="column is-4-desktop is-6-tablet">
                        <div class="card has-text-centered mb-lg-0 mb-3 " data-aos="fade-down" data-aos-delay="300">
                            <div class="py-6">
                                ...
                                <a href="/moodlepe/local/moodlepe/register/index.php?offre=2" class="btn btn-main mt-5" aria-disabled="true">Souscrire</a>
                            </div>
                        </div>
                    </div>
                    <div class="column is-4-desktop is-6-tablet">
                        <div class="card has-text-centered mb-lg-0 mb-3" data-aos="fade-down" data-aos-delay="500">
                            <div class="py-6">
                                ...
                                <a href="/moodlepe/local/moodlepe/register/index.php?offre=3" class="btn btn-solid-border mt-5" aria-disabled="true">Souscrire</a>
                            </div>
                        </div>
                    </div>
                </div>
