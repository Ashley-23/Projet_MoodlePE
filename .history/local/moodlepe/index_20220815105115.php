                ...
                <table class="admintable generaltable table-sm" id="users">
                    ...
                    <tbody>
                        <tr class="">
                            ...
                            <td class="cell c5" style=""><a href="http://localhost:8080/moodle4test/moodle4test/user/profile.php?id=3"><i class="icon fa fa-cog fa-fw " title="Modifier" role="img" aria-label="Modifier"></i></a></td>
