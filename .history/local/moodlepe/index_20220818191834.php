...
$role_check = $mysql->query("SELECT r.id,r.name, a.userid FROM mdl_role r JOIN mdl_role_assignments a ON r.id = a.roleid WHERE a.userid='$userid' AND a.roleid='$'", MYSQLI_USE_RESULT);
