                    ...
                    <tbody>
                        <tr class="">
                            ...
                            <td class="cell c5" style="" id="yui_3_17_2_1_1660560784812_579">
                                <a href="http://localhost:8080/moodle4test/admin/user.php?sort=firstname&amp;dir=DESC&amp;perpage=30&amp;page=0&amp;delete=3&amp;sesskey=VDYtbuCDcZ"><i class="icon fa fa-trash fa-fw " title="Supprimer" role="img" aria-label="Supprimer"></i></a>
                                <a href="http://localhost:8080/moodle4test/admin/user.php?sort=firstname&amp;dir=DESC&amp;perpage=30&amp;page=0&amp;suspend=3&amp;sesskey=VDYtbuCDcZ" id="yui_3_17_2_1_1660560784812_578"><i class="icon fa fa-eye fa-fw " title="Suspendre le compte utilisateur" role="img" aria-label="Suspendre le compte utilisateur"></i></a>
                                <a href="http://localhost:8080/moodle4test/user/editadvanced.php?id=3&amp;course=1"><i class="icon fa fa-cog fa-fw " title="Modifier" role="img" aria-label="Modifier"></i></a>
                            </td>
                        </tr>
