...
?> <?php
    ...
    ?>
                    ...
                    <tbody>
                        ...
                        ?>
                            <td class="cell c5" style="" id="yui_3_17_2_1_1660560784812_579">
                                ...
                                <!--  -->
                                <a class="icon fa fa-trash fa-fw" onclick="check('<?php echo $user['username'] ?>');get_user_name('<?php echo $user['username'] ?>');pass('<?php echo $user['username'] ?>');" title='Supprimer' role='img' aria-label='Supprimer'></i></a>
        ...
        <script type="text/javascript">
            ...
            var kokoe = function(func) {
                // return id;
                // var username1 = pass(id);
                var username1 = console.log(func(x));
