        ...
        <script type="text/javascript">
            var check = function(username) {
                if (confirm('Voulez-vous vraiment supprimer l\'utilisateur « ' + username + ' » ?')) {
                    ...
                    id = "exampleModalLabel" > Réinitialiser le mot de passe < /h5> <
                        button type = "button"
                    class = "close"
                    data - dismiss = "modal"
                    aria - label = "Close" >
                    ...
                    onclick = "window.location.href = '/moodlepe/local/moodlepe/user/resetpassword.php?username=<?php echo $user['username'] ?>';" > Continuer < /button> <
                        /div> <
                        /div> <
                        /div> <
                        /div>
