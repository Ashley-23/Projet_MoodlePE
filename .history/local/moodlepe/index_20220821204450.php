...
?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="send_username" type="button" class="btn btn-primary" onclick="">Continuer</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script type="text/javascript">
            ...
            var resetpassword = function(username) {
                ...
                btn.setAttribute("onclick", "/moodlepe/local/moodlepe/user/resetpassword.php?username=" + username);
