...
?>
                    ...
                    <tbody>
                        ...
                        ?>
                            <td class="cell c5" style="" id="yui_3_17_2_1_1660560784812_579">
                                ...
                                <a class="icon fa fa-eye fa-fw " onclick="ShowModal('myModal-<?= $value['username'] ?>')" title="Réinitialiser le mot de passe" role="img" aria-label="Réinitialiser le mot de passe"></a>
        ...
        <script type="text/javascript">
            ...
            var resetpassword = function(username) {
                ...
                var div = document.getElementById('modal-body 1');
        ...
        <div class="modal fade" id="myModal-<?= $value['username']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body 1" id="modal-body 1">
                        Voulez vous reinitialiser le mot de passe de
                    </div>
