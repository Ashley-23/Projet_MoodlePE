                    ...
                    <tbody>
                        ...
                        ?>
                            <td class="cell c5" style="" id="yui_3_17_2_1_1660560784812_579">
                                ...
                                <a class="icon fa fa-eye fa-fw " data-toggle="modal" data-target="#view-property-<?php echo $user['username']; ?>" title="Réinitialiser le mot de passe" role="img" aria-label="Réinitialiser le mot de passe"></a>
                        ...
                        <div class='modal fade' id="view-property-<?php echo $properties['propertie_id']; ?>" tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
