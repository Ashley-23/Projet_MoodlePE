            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="suppr_user" type="button" class="btn btn-primary" onclick="kokoe('<?php echo $user['username'] ?>');">Continuer</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="suppr" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Annuler</button>
                        <button id="send_username" type="button" class="btn btn-primary" onclick="ash('<?php echo $user['username'] ?>');">Continuer</button>
                    </div>
                </div>
            </div>
        </div>
