...
if (isset($_GET['reset'])) {
    ...
    if ($reset == "ok") {
        ...
        <script>  if(isset($_GET['subproject'])&&($_GET['subproject'] == "no")) {                swal("<?php echo $oops_message ?>", "<?php echo $error_not_eligible_submission_project ?>", "error");              <?php }                          if(isset($_GET['create_account'])&&($_GET['create_account'] == "success")) { ?>                swal("<?php echo $congratulations ?>", "<?php echo $create_account_success_message ?>", "success");              <?php } ?></script>
    }
}
