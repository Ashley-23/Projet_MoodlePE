                    ...
                    <tbody>
                        ...
                        ?>
                            <td class="cell c5" style="" id="yui_3_17_2_1_1660560784812_579">
                                <input type="submit" onclick="getid('<?php echo $user['username'] ?>');" value="Modifier"><a href="" onclick="check('<?php echo $user['username'] ?>');"><i class=' icon fa fa-trash fa-fw' title='Supprimer' role='img' aria-label='Supprimer'></i></a>
