...
?>
                    ...
                    <tbody>
                        ...
                        ?>
                            <td class="cell c5" style="" id="yui_3_17_2_1_1660560784812_579">
                                ...
                                <a href="" onclick="restepassword('<?php echo $user['username'] ?>');"><i class="icon fa fa-eye fa-fw " title="Réinitialiser le mot de passe" role="img" aria-label="Réinitialiser le mot de passe"></i></a>
                            </td>
        ...
        <script type="text/javascript">
            ...
            var restepassword = function(username) {
                if (confirm('Voulez-vous vraiment réinitialiser le mot de passe de l\'utilisateur « ' + username + ' » ?')) {
                    window.location.href = "/moodlepe/local/moodlepe/user/restepassword.php?username=" + username;
                } else {
                    return false;
                };
            }
