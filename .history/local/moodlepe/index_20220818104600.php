                    ...
                    <tbody>
                        ...
                        ?>
                            <td class="cell c5" style="" id="yui_3_17_2_1_1660560784812_579">
                                ...
                                <a class="icon fa fa-eye fa-fw " onclick="resetpassword('<?php echo $user['username'] ?>');"> <input type=" submit" style="color:blue" value="Mod" title="Réinitialiser le mot de passe" role="img" aria-label="Réinitialiser le mot de passe"></a>
                            </td>
