...
if (isset($_GET['username'])) {
    ...
    while ($row = $utilisateur->fetch_assoc()) {
        ...
        $fonctionnaire[] = array('id' => $row['id'], 'nom' => $row['lastname'], 'prenom' => $row['firstname'], 'username' => $row['username'], 'email' => $row['email']);
    }
    ...
    echo "</br> Id : " . $$users[] = array('id' => $row['id'], 'nom' => $row['lastname'], 'prenom' => $row['firstname'], 'username' => $row['username'], 'email' => $row['email'], 'entreprise' => $row['name']);
    id . "</br> Username : " . $userusername . "</br> Firstname" . $userfirstname . "</br> Lastname" . $userlastname . "</br> Email" . $useremail;
