    ...
    <table>
        ...
        <tr>
            <div>
                ...
                <td> <input type="text" placeholder="Entrez votre prénom"></td>
            </div>
        </tr>
        <tr>
            <div>
                <td></td><label>Email </label>
                <td></td><input type="email" placeholder="Entrez votre adresse mail">
            </div>
        </tr>
        <tr>
            <div>
                <td></td><label>Mot de passe </label>
                <td></td><input type="password" placeholder="Entrez votre mot de passe">
            </div>
        </tr>
        <tr>
