...
if (isset($_POST['username']) || isset($_POST['lastname']) || isset($_POST['firstname']) || isset($_POST['email']) || isset($_POST['entreprise']) || isset($_POST['password']) || isset($_POST['entrepriseid'])) {
    ...
    $check_user_firstname = $mysql->query("SELECT * FROM mdl_user WHERE UPPER(firstname='$firstname'");
    $check_user_lastname = $mysql->query("SELECT * FROM mdl_user WHERE UPPER(lastname='$lastname'");
    $check_user_email = $mysql->query("SELECT * FROM mdl_user WHERE UPPER(email='$email'");
