...
<form method="post" action="">
    ...
    <div class="fdescription required">
        Ce formulaire comprend des champs requis, marqués <i class="icon fa fa-exclamation-circle text-danger fa-fw " title="Champ requis" role="img" aria-label="Champ requis"></i>.</div>
