    ...
    <table>
        <tr>
            <div>
                ...
                <td><input type="text" placeholder="Entrez votre nom" require></td>
            </div>
        </tr>
        <tr>
            <div>
                <td> <label>Prénom </label></td>
                <td> <input type="text" placeholder="Entrez votre prénom" require></td>
            </div>
        </tr>
        <tr>
            <div>
                <td><label>Email </label></td>
                <td><input type="email" placeholder="Entrez votre adresse mail" require></td>
            </div>
        </tr>
        <tr>
            <div>
                <td><label>Mot de passe </label></td>
                <td><input type="password" placeholder="Entrez votre mot de passe" require></td>
            </div>
        </tr>
        <tr>
            <td>
