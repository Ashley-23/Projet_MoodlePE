...
<form method="post" action="">
    ...
    <div id="fitem_id_newpassword" class="form-group row  fitem   ">
        ...
        <div class="col-md-9 form-inline align-items-start felement" data-fieldtype="text">
            ...
            <div class="fdescription required">Ce formulaire comprend des champs requis, marqués <i class="icon fa fa-exclamation-circle text-danger fa-fw " title="Champ requis" role="img" aria-label="Champ requis"></i>.</div>
