...
if (isset($_GET['username'])) {
    ...
    echo "</br> Le nom de famille en minuscule sera : " . $lower_lastname;
    echo "</br> Le prénom en minuscule sera : " . $lower_firstname;

    $resetpassword = "#" . $lower_firstname . "*" . $lower_lastname . "*1234";


    $str_cap_one = "this is php. php is cool. php is simple.";
