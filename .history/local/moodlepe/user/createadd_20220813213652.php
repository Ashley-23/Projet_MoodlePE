...
if (isset($_POST['username']) || isset($_POST['lastname']) || isset($_POST['firstname']) || isset($_POST['email']) || isset($_POST['entreprise']) || isset($_POST['password']) || isset($_POST['entrepriseid'])) {
    ...
    $mdl_cohort_members  = $mysql->query("INSERT INTO mdl_cohort_members ( id , username, firstname, lastname,email ,password ,enterprise ,timecreated ,active  't',suppr 'f',suppr_user_id ,userid')", MYSQLI_USE_RESULT);
} else {
