...
?>
    ...
    <!-- *********************************** RETOURNER A LA LISTE D'UTILISATEURS****************************************** -->
    <form action="/moodlepe/local/moodlepe/index.php">


        inpu < <div class="col-md-9 form-inline align-items-start felement" data-fieldtype="group" id="yui_3_17_2_1_1660412984554_753">
    ...
    <!-- *********************************** FIN RETOURNER A LA LISTE D'UTILISATEURS****************************************** -->
    ...
    <form method="post" action="/moodlepe/local/moodlepe/user/createdupdate.php">
        ...
        <div id="fitem_id_lastname" class="form-group row  fitem   ">
            ...
            <div class="col-md-9 form-inline align-items-start felement" data-fieldtype="text">
                <input type="text" class="form-control " name="lastname" id="id_lastname" value="<?php echo $userlastname ?>" placeholder="<?php echo $userlastname ?>" size="30" maxlength="100" required>
        ...
        <div id="fitem_id_firstname" class="form-group row  fitem   ">
            ...
            <div class="col-md-9 form-inline align-items-start felement" data-fieldtype="text">
                <input type="text" class="form-control " name="firstname" id="id_firstname" value="<?php echo $userfirstname ?>" placeholder="<?php echo $userfirstname ?>" size="30" maxlength="100" required>
        ...
        <div id="fitem_id_email" class="form-group row  fitem   ">
            ...
            <div class="col-md-9 form-inline align-items-start felement" data-fieldtype="text">
                <input type="email" class="form-control " name="email" id="id_email" value="<?php echo $useremail ?>" placeholder="<?php echo $useremail ?>" size="30" maxlength="100" required>
        ...
        <div class=" col-md-9 form-inline align-items-start felement" data-fieldtype="group" id="yui_3_17_2_1_1660412984554_753">
            <fieldset class="w-100 m-0 p-0 border-0" id="yui_3_17_2_1_1660412984554_752">
                ...
                " id="id_submitbutton" value="Modifier" data-initial-value="Modifier">
                        </span>
                        <div class="form-control-feedback invalid-feedback" id="id_error_submitbutton">
