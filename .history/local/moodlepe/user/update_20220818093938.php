...
?>
    ...
    <form method="post" action="">
        ...
        <div id="fitem_id_email" class="form-group row  fitem   ">
            ...
            <div class="col-md-9 form-inline align-items-start felement" data-fieldtype="text">
                <input type="email" class="form-control " name="email" id="id_email" value="<?php echo $userusername ?>" placeholder="<?php echo $userusername ?>" size="30" maxlength="100" required>
