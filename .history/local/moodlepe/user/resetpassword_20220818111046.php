...
if (isset($_GET['username'])) {
    ...
    $update_mdl_user = "UPDATE mdl_local_moodlepe_suppr SET password='$resetpassword' WHERE id='$userid'";
    $mysql->query($update_mdl_user);


    //REINITIALISE LE MOT DE PASSE DE L'UTILISATEUR DANS NOTRE TABLE mdl_user
    $update_mdl_user = "UPDATE mdl_user SET password='$email' WHERE id='$userid'";
    $mysql->query($update_mdl_user);
