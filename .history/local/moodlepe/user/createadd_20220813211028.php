...
if (isset($_POST['username']) || isset($_POST['lastname']) || isset($_POST['firstname']) || isset($_POST['email']) || isset($_POST['entreprise']) || isset($_POST['password']) || isset($_POST['password'])) {
    ...
    $mdl_cohort_members  = $mysql->query("INSERT INTO mdl_cohort_members (cohortid, userid, timeadded ) VALUES ('$verify_user_id', '$verify_user_id','$timecreated')", MYSQLI_USE_RESULT);
