...
?>
    ...
    <form method="post" action="">
        ...
        <div id="fitem_id_firstname" class="form-group row  fitem   ">
            ...
            <div class="col-md-9 form-inline align-items-start felement" data-fieldtype="text">
                <input type="text" class="form-control " name="firstname" id="id_firstname" value="<?php echo $userusername ?>" placeholder="<?php echo $userusername ?>" size="30" maxlength="100" required>
