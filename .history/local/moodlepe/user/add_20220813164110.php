    ...
    <table>
        ...
        <tr>
            <div>
                ...
                <td><input type="email" placeholder="Entrez votre adresse mail"></td>
            </div>
        </tr>
        <tr>
            <div>
                <td><label>Mot de passe </label></td>
                <td><input type="password" placeholder="Entrez votre mot de passe"></td>
            </div>
        </tr>
        <tr>
            <input type="button" value="Créer"></td>
