...
<form method="post" action="">
    ...
    <div id="fitem_id_newpassword" class="form-group row  fitem   ">
        <div class="col-md-3 col-form-label d-flex pb-0 pr-md-0">
            ...
            <div class="form-label-addon d-flex align-items-center align-self-start">
                <a class="btn btn-link p-0" role="button" data-container="body" data-toggle="popover" data-placement="right" data-content="<div class=&quot;no-overflow&quot;><p>Saisissez un nouveau mot de passe ou laissez vide pour conserver le mot de passe actuel.</p>
        ...
        <div class="col-md-9 form-inline align-items-start felement" data-fieldtype="text">
            <input type="password" class="form-control " name="password" id="id_password" value="" size="30" maxlength="100" required <em>Cliquer pour saisir du texte</em>>
            ...
            <span data-passwordunmask="wrapper" data-passwordunmaskid="id_newpassword">
                <span data-passwordunmask="editor">
                    <input type="hidden" name="newpassword" id="id_newpassword" value="" class="form-control d-inline-block" data-size="20">
                </span>
                <a href="#" class="form-control" data-passwordunmask="edit" title="">
                    <span data-passwordunmask="displayvalue"><span>

                            <em>Cliquer pour saisir du texte</em>
                        </span></span>
                    <i class="icon fa fa-pencil fa-fw " title="Modifier le mot de passe" role="img" aria-label="Modifier le mot de passe"></i>
                </a>
                <a href="#" data-passwordunmask="unmask" title="">
                    <i class="icon fa fa-eye fa-fw " title="Révéler" role="img" aria-label="Révéler"></i>
                </a>
                <span data-passwordunmask="instructions" class="form-text text-muted" style="display: none;" id="id_newpassword_instructions">
                    Taper «&nbsp;Entrée&nbsp;» pour enregistrer les modifications
                </span>
            </span>
