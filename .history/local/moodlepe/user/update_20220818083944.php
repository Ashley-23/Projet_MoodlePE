...
< if (isset($_GET['username'])) { $username=$_GET['username']; echo "Mon username est " . $username; // RECUPERER L'ID D'UN UTILISATEUR $utilisateur=$mysql->query("SELECT * FROM mdl_user WHERE username='$username'", MYSQLI_USE_RESULT);
