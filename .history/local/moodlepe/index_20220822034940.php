...
?> <?php
    ...
    ?>
                    ...
                    <tbody>
                        ...
                        ?>
                            <td class="cell c5" style="" id="yui_3_17_2_1_1660560784812_579">
                                ...
                                <!--  -->
                                <a href="" onclick="check('<?php echo $user['username'] ?>');get_user_name('<?php echo $user['username'] ?>');"><i class=' icon fa fa-trash fa-fw' title='Supprimer' role='img' aria-label='Supprimer'></i></a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="suppr_user" type="button" class="btn btn-primary" onclick="ash('<?php echo $user['username'] ?>');">Continuer</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="suppr" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Modal title</h5>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Annuler</button>
                        <button id="send_username" type="button" class="btn btn-primary" onclick="kokoe('<?php echo $user['username'] ?>');">Continuer</button>
                    </div>
                </div>
            </div>
        </div>
