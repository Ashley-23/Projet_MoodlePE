            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button id="suppr_user" type=" button" class="btn btn-secondary" data-dismiss="modal">Annuler</button>
        ...
        <div class="modal fade" id="suppr" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Voulez vous supprimer l'utilisateur <span id="recup_username"> <span> ? </div>
                    <div class="modal-footer">
