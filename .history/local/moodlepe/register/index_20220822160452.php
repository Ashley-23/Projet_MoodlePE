		...
		<div class="wrapper">
            ...
            <li class="list-group-item d-flex justify-content-between">
              ...
              <strong> 0 </strong>
				...
				<form method="POST" action="/moodlepe/local/moodlepe/register/index2.php">
					...
					<div class="form-group">
						...
						<input type="text" placeholder="Confirmer l'Entreprise" class="form-control" id="confirm_entreprise" onkeyup='et();' required name="userentreprise2">
					</div>
					...
					<div class="form-wrapper">
						<span class="has-text-white h4">Le mot de passe doit comporter au moins 8 caractère(s), au moins 1 chiffre(s), au moins 1 minuscule(s), au moins 1 majuscule(s), au moins 1 caractère(s) spéciaux tels que *, - ou # </span>
						<input type="password" placeholder="Mot de passe" class="form-control" id="password" required name="userpassword1" required pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,24}$">
					...
					<!-- </div> -->
					<p> <a href="/moodlepe/index.php"> Retourner à l'accueil</a> </p>
