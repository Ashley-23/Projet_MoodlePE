...
if (isset($_GET['emailorusernameerror'])) {

    $emailorusernameerror = $_GET['emailorusernameerror'];

    if ($emailorusernameerror == "ok") {
        echo "<script> alert('L/'email ou le nom d'utilisateur saisit existe déjà') </script>";
    }
}
