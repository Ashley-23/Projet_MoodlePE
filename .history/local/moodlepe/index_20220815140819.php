                ...
                <table class="admintable generaltable table-sm" id="users">
                    ...
                    <tbody>
                        ...
                        foreach ($users as $user) {
                            ...
                            echo "<td class='cell c5' style=' id='yui_3_17_2_1_1660560784812_579'>
                            onclick="getid('<?php echo $user['username'] ?>');"<i class='icon fa fa-trash fa-fw' title='Supprimer' role='img' aria-label='Supprimer'></i></a>
