...
<div class="form-item row" id="admin-coursecolor9">
    ...
    <div class="form-setting col-sm-9">
        <div class="form-colourpicker defaultsnext" id="yui_3_17_2_1_1659972010767_127">
            <div class="admin_colourpicker clearfix"><img alt="" class="colourdialogue" src="http://localhost:8080/moodle4test/theme/image.php/boost/core/1659960092/i/colourpicker">
