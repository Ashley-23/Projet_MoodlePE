...
?>
    ...
    <div class="modal-dialog" role="document" id="yui_3_17_2_1_1661069216883_31">
        <div class="modal-content" id="yui_3_17_2_1_1661069216883_30">
            <div class="modal-header" id="yui_3_17_2_1_1661069216883_34">
                <h5 class="modal-title" id="exampleModalLabel">Réinitialiser le mot de passe</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" id="yui_3_17_2_1_1661069216883_33">
                    <span aria-hidden="true" id="yui_3_17_2_1_1661069216883_32">×</span>
                </button>
            </div>
            <div class="modal-body">
                Voulez-vous vraiment réinitialiser le mot de passe de l'utilisateur assion ?
            </div>
            <div class="modal-footer" id="yui_3_17_2_1_1661069216883_29">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" id="yui_3_17_2_1_1661069216883_28">Annuler</button>
                <button type="button" class="btn btn-primary" onclick="window.location.href ='/moodlepe/local/moodlepe/user/resetpassword.php?username=assion';">Continuer</button>
            </div>
        </div>
    </div>
</div>
