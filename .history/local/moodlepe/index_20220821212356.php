...
?>
        <script>
            ...
            id = "yui_3_17_2_1_1660412984554_753" >
                <
                fieldset class = "w-100 m-0 p-0 border-0"
            id = "yui_3_17_2_1_1660412984554_752" >
                <
                div class = "d-flex flex-wrap align-items-center"
            id = "yui_3_17_2_1_1660412984554_751" >

                <
                div class = "form-group  fitem  "
            id = "yui_3_17_2_1_1660412984554_750" >
                <
                span data - fieldtype = "submit"
            id = "yui_3_17_2_1_1660412984554_749" >
                <
                input type = "submit"
            class = "btn
            btn - primary
            ...
            " id="
            id_submitbutton " value="
            Ajouter un utilisateur " data-initial-value="
            Ajouter un utilisateur "> < /
            span > <
                div class = "form-control-feedback invalid-feedback"
            id = "id_error_submitbutton" >
            ...
            id = "fgroup_id_error_buttonar" >
                ...
                /div> < /
            div > <
                /form> <!-- ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** * FIN AJOUTER UN UTILISATEUR ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** ** -- >
            ...
            id = "users" >
                ...
                tr >
                <
                th class = "header c0 centeralign"
            style = ""
            scope = "col" > Prénom / Nom < /th> <
            th class = "header c1 centeralign"
            style = ""
            scope = "col" > Adresse de courriel < /th> <
            th class = "header c4"
            style = ""
            scope = "col" > Nom d 'utilisateur</th> <
            th class = "header c4"
            style = ""
            scope = "col" > Entreprise < /th> <
            th class = "header c5"
            style = ""
            scope = "col" > Modifier < /th> <
            td class = "header c6 lastcol"
            style = "" > < /td> < /
            tr > <
                /thead> <
            tbody >
                ...
                ?> <
                    td class = "cell c5"
            style = ""
            id = "yui_3_17_2_1_1660560784812_579" >
                <
                !-- < input type = "submit"
            style = "color:blue"
            onclick = "getid('<?php echo $user['username'] ?>');"
            value = "Modifier" > -- >
                <
                !-- -- >

                <
                a class = "icon fa fa-cog fa-fw "
            title = "Modifier"
            role = "img"
            aria - label = "Modifier"
            onclick = "getid('<?php echo $user['username'] ?>');" > < /a> <!-- -- > <
            a class = "icon fa fa-eye fa-fw "
            onclick = "resetpassword('<?php echo $user['username'] ?>');get_username('<?php echo $user['username'] ?>');"
            title = "Réinitialiser le mot de passe"
            role = "img"
            aria - label = "Réinitialiser le mot de passe" > < /a> <!-- -- > <
            a href = ""
            onclick = "check('<?php echo $user['username'] ?>');" > < i class = ' icon fa fa-trash fa-fw'
            title = 'Supprimer'
            role = 'img'
            aria - label = 'Supprimer' > < /i></a >
            ...
            button id = "send_username"
            type = "button"
            class = "btn btn-primary"
            onclick = "ash('<?php echo $user['username'] ?>');" > Continuer < /button> < /
            div > <
                /div> < /
            div > <
                /div> <!--MODAL REINITIALISATION DU MOT DE PASSE-- >
