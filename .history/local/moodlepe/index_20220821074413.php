            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="window.location.href = '/moodlepe/local/moodlepe/user/resetpassword.php?username=" + username;">Continuer</button>
                    </div>
                </div>
            </div>
        </div>
