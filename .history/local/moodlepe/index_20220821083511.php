...
if (isset($_GET['reset'])) {
    ...
    if ($reset == "ok") {
        ...
        echo "
?>
        <div class='modal fade' tabindex='-1' role='dialog' aria-labelledby='exampleModal' aria-hidden='true' style='display: block;'>
            <div class='modal-dialog' role='document'>
                <div class='modal-content'>
                    <div class='modal-header'>
                        <h5 class='modal-title' id='exampleModal'>Réinitialiser le mot de passe</h5>
