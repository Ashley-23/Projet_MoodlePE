...
?>
        <script>
            ...
            document.getElementById('#reset').onload().modal('show');
        ...
        <div class="modal fade" id="suppr" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel7" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="reset" class="btn btn-secondary" data-dismiss="modal">Annuler</button>
                        <button id="send_username" type="submit" class="btn btn-primary" onclick="kokoe('<?php echo $user['username'] ?>');">Continuer</button>
                    </div>
                </div>
            </div>
        </div>
